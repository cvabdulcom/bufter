            ...
            <div class="col-md-3 table-responsive">
              <div class="input-group pull-left">
                ...
                <span class="input-group-btn">
                    <form method="GET" action="<?php echo base_url('dashboard/laporan_dokumen'); ?>">
              ...
              <table class="table table-bordered table-hover" id="laporan">
                <thead>
                  <tr class="bg-primary">
                    ...
                    <th class="text-center">Name Loading Master</th>
                ...
                <tbody>
                  <?php
                    ...
                    foreach($this->db->query("SELECT * FROM tbl_masterrequest WHERE id_pengguna='$id_pengguna' AND date_request BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND approve='YA' ORDER BY id DESC")->result_array() as $tampil):
                      $no++;
                      $id = $tampil['id'];
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="text-center"><?php echo $name_of_loading_master; ?></td>
                      <td class="text-center"><?php echo $no_document; ?></td>
                      <td class="text-right" width="10">
                        <a href="<?php echo base_url('assets/backend/file_dokumen_request/').$file_dokumen; ?>" target="_blank"><i class="fa fa-file-pdf-o"></i></a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
