              ...
              <table class="table table-bordered table-hover" id="laporan">
                ...
                <tbody>
                  <?php
                    ...
                    foreach($this->db->query("SELECT * FROM tbl_tankticket WHERE id_pengguna='$id_pengguna' AND date BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY id DESC")->result_array() as $tampil):
                      $no++;
                      $id = $tampil['id'];
