            ...
            <div class="col-md-3 table-responsive">
              <div class="input-group pull-left">
                ...
                <span class="input-group-btn">
                    <form method="GET" action="<?php echo base_url('dashboard/laporan_masterrequest'); ?>">
              ...
              <table class="table table-bordered table-hover" id="laporan">
                ...
                <tbody>
                  <?php
                    ...
                    foreach($this->db->query("SELECT * FROM tbl_masterrequest WHERE date_request BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND approve='YA' ORDER BY id DESC")->result_array() as $tampil):
                      $no++;
                      $id = $tampil['id'];
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="text-right" width="10">
                        <a href="<?php echo base_url('dashboard/cetak_request?id=').$id; ?>" target="_blank"><i class="fa fa-download"></i></a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
